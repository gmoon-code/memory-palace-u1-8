...
def main() -> None:
    ...
    require('@app.get("/api/admin/courses")' in main_py, "protected admin course registry route is missing")
    ...
    require('apiRequest(courseApiUrl("/api/admin/catalog/summary"))' in js_text, "admin dashboard is not using the protected course-scoped catalog summary")
    require('apiRequest(courseApiUrl("/api/admin/catalog/course-map"))' in js_text, "admin dashboard is not using the protected course-scoped course map")
    require('apiRequest("/api/admin/courses")' in js_text, "admin dashboard is not loading the protected course registry")
    require('id="admin-course-select"' in html_text, "Content Studio course selector is missing")
